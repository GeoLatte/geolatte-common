...
public class IsBeforeTest extends AbstractTemporalExpressionTest {
    ...
    public void testEvaluate() throws Exception {
        ...
        // Test the true case
        exp = new IsBefore(nowDateExpression, laterDateExpression);
        Assert.assertEquals(true, exp.evaluate(theObjectToEvaluate));

        // Test the false case
        exp = new IsBefore(laterDateExpression, nowDateExpression);
        Assert.assertEquals(false, exp.evaluate(theObjectToEvaluate));

        // Test another false case (equals
        exp = new IsBefore(nowDateExpression, nowDateExpression);
        Assert.assertEquals(false, exp.evaluate(theObjectToEvaluate));
