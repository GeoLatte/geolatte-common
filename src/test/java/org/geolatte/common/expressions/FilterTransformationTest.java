...
/**
 * <p>
 * Tests the FilterTransformation class.
 * </p>
 * <p>
 * <i>Creation-Date</i>: 01-Jul-2010<br>
 * <i>Creation-Time</i>:  16:25:54<br>
 * </p>
 *
...
public class FilterTransformationTest {
    ...
    public void testTransform() throws Exception {
        ...
        transformation = new FilterTransformation<FilterableObject>(filter);

        Assert.assertEquals(true, transformation.transform(object));

        object.setAnInteger(5);
        Assert.assertEquals(false, transformation.transform(object));
    }
    ...
    public void testTransformWithNullFilter() throws Exception {
        ...
        // No filter -> anything should pass
        transformation = new FilterTransformation<FilterableObject>(null);
