...
public class IsLessThanTest extends AbstractNumberComparisonTest {
    ...
    public void testEvaluate() throws Exception {
        ...
        // Test the true case
        exp = new IsLessThan(lowNumberExpression, highNumberExpression);
        Assert.assertEquals(true, exp.evaluate(theObjectToEvaluate));

        // Test the false case
        exp = new IsLessThan(highNumberExpression, lowNumberExpression);
        Assert.assertEquals(false, exp.evaluate(theObjectToEvaluate));

        // Test another false case (equals)
        exp = new IsLessThan(highNumberExpression, highNumberExpression);
        Assert.assertEquals(false, exp.evaluate(theObjectToEvaluate));
