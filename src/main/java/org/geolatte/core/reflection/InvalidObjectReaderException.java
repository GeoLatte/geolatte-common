...
package org.geolatte.core.reflection;
 ...
 * @since SDK1.5
 */
public class InvalidObjectReaderException extends Exception {
     ...
     */
    public InvalidObjectReaderException() {
	super();
    }
     ...
     */
    public InvalidObjectReaderException(String message) {
	super(message);
    }
     ...
     * @since  1.4
     */
    public InvalidObjectReaderException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since  1.4
     */
    public InvalidObjectReaderException(Throwable cause) {
        super(cause);
    }
}
