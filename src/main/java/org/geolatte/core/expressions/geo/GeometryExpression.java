...
import org.geolatte.core.expressions.BasicTypeSwitch;
...
public abstract class GeometryExpression implements Expression<Geometry> {
     ...
     * For example, on an Expression<Integer>, this method calls the {@link org.geolatte.core.expressions.BasicTypeSwitch#caseInteger(org.geolatte.core.expressions.Expression)} method on the given switcher.
     *
