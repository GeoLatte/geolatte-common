...
public abstract class BooleanComparisonExpression extends BooleanExpression implements BinaryBooleanExpression<Boolean> {
    ...
    /**
     * The left hand side comparable expression (this returns a more specifically typed version of the {@link org.geolatte.core.expressions.BinaryBooleanExpression#getLeft()} method.
    ...
    /**
     * The right hand side comparable expression (this returns a more specifically typed version of the {@link org.geolatte.core.expressions.BinaryBooleanExpression#getRight()} method.
