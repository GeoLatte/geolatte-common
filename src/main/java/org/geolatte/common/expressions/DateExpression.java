...
/**
 * <p>
 * Abstract base class for all Date expressions.
 * </p>
 * <p>
 * <i>Creation-Date</i>: 01-Jun-2010<br>
 * <i>Creation-Time</i>:  18:34:02<br>
 * </p>
 *
 ...
 * @since SDK1.5
 */
public abstract class DateExpression implements ComparableExpression<Date> {

    public int compareTo(Object evaluateObject, Date value) throws ClassCastException, NullPointerException {

        Date thisDate = evaluate(evaluateObject);
